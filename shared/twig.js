...
Twig.prototype.rankOf = function(key) {
	...
	var x = Jools.is(this.copse[key]) ? ranks.indexOf(key) : -1;
...
*/
Jools.lazyFixate(Twig.prototype, 'length', function() {
...
Twig.prototype.newUID = function() {
	var u = Jools.uid();
	return (!Jools.is(this.copse[u])) ? u : this.newUID();
};

/**
| Returns the twig type.
*/
Twig.getType = function(o) {
