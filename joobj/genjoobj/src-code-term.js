...
/**/}
	...
	if( inherit && v_term === inherit.term )
	{
		return inherit;
	}

	return new Term( 8833, v_term );
};
...
| Reflection.
*/
Term.prototype.reflect = 'Term';


/*
| Sets values by path.
*/
Term.prototype.setPath = JoobjProto.setPath;


/*
| Gets values by path
*/
Term.prototype.getPath = JoobjProto.getPath;
