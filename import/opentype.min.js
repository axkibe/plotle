...
"use strict";function Hinting(o){this.font=o,this._fpgmState=this._prepState=void 0,this._errorState=0}function roundOff(o){return o}function roundToGrid(o){return Math.sign(o)*Math.round(Math.abs(o))}function roundToDoubleGrid(o){return Math.sign(o)*Math.round(Math.abs(2*o))/2}function roundToHalfGrid(o){return Math.sign(o)*(Math.round(Math.abs(o)+.5)-.5)}function roundUpToGrid(o){return Math.sign(o)*Math.ceil(Math.abs(o))}function roundDownToGrid(o){return Math.sign(o)*Math.floor(Math.abs(o))}function UnitVector(o,t){this.x=o,this.y=t,this.axis=void 0,this.slope=t/o,this.normalSlope=-o/t,Object.freeze(this)}function getUnitVector(o,t){var i=Math.sqrt(o*o+t*t);return o/=i,t/=i,1===o&&0===t?xUnitVector:0===o&&1===t?yUnitVector:new UnitVector(o,t)}function HPoint(o,t,i,n){this.x=this.xo=Math.round(64*o)/64,this.y=this.yo=Math.round(64*t)/64,this.lastPointOfContour=i,this.onCurve=n,this.prevPointOnContour=void 0,this.nextPointOnContour=void 0,this.xTouched=!1,this.yTouched=!1,Object.preventExtensions(this)}function State(o,t){switch(this.env=o,this.stack=[],this.prog=t,o){case"glyf":this.zp0=this.zp1=this.zp2=1,this.rp0=this.rp1=this.rp2=0;case"prep":this.fv=this.pv=this.dpv=xUnitVector,this.round=roundToGrid}}function execGlyph(o,t){var i,n,r,e=t.ppem/t.font.unitsPerEm,p=e,a=o.components;if(State.prototype=t,a){var d=t.font;n=[],i=[];for(var c=0;c<a.length;c++){var v=a[c],s=d.glyphs.get(v.glyphIndex);r=new State("glyf",s.instructions),execComponent(s,r,e,p);for(var u=Math.round(v.dx*e),P=Math.round(v.dy*p),h=r.gZone,f=r.contours,M=0;M<h.length;M++){var R=h[M];R.xTouched=R.yTouched=!1,R.xo=R.x=R.x+u,R.yo=R.y=R.y+P}var b=n.length;n.push.apply(n,h);for(var l=0;l<f.length;l++)i.push(f[l]+b)}o.instructions&&!r.inhibitGridFit&&(r=new State("glyf",o.instructions),r.gZone=r.z0=r.z1=r.z2=n,r.contours=i,n.push(new HPoint(0,0),new HPoint(Math.round(o.advanceWidth*e),0)),exec(r),n.length-=2)}else r=new State("glyf",o.instructions),execComponent(o,r,e,p),n=r.gZone;return n}function execComponent(o,t,i,n){var r,e,p=o.points||[],a=p.length,d=t.gZone=t.z0=t.z1=t.z2=[],c=t.contours=[];for(r=0;r<a;r++)e=p[r],d[r]=new HPoint(e.x*i,e.y*n,e.lastPointOfContour,e.onCurve);var v,s;for(r=0;r<a;r++)e=d[r],v||(v=e,c.push(r)),e.lastPointOfContour?(e.nextPointOnContour=v,v.prevPointOnContour=e,v=void 0):(s=d[r+1],e.nextPointOnContour=s,s.prevPointOnContour=e);t.inhibitGridFit||(d.push(new HPoint(0,0),new HPoint(Math.round(o.advanceWidth*i),0)),exec(t),d.length-=2)}function exec(o){var t=o.prog;if(t){var i,n=t.length;for(o.ip=0;o.ip<n;o.ip++){if(i=instructionTable[t[o.ip]],!i)throw new Error("unknown instruction: 0x"+Number(t[o.ip]).toString(16));i(o)}}}function initTZone(o){for(var t=o.tZone=new Array(o.gZone.length),i=0;i<t.length;i++)t[i]=new HPoint(0,0)}function skip(o,t){var i,n=o.prog,r=o.ip,e=1;do if(i=n[++r],88===i)e++;else if(89===i)e--;else if(64===i)r+=n[r+1]+1;else if(65===i)r+=2*n[r+1]+1;else if(i>=176&&i<=183)r+=i-176+1;else if(i>=184&&i<=191)r+=2*(i-184+1);else if(t&&1===e&&27===i)break;while(e>0);o.ip=r}function SVTCA(o,t){t.fv=t.pv=t.dpv=o}function SPVTCA(o,t){t.pv=t.dpv=o}function SFVTCA(o,t){t.fv=o}function SPVTL(o,t){var i,n,r=t.stack,e=r.pop(),p=r.pop(),a=t.z2[e],d=t.z1[p];o?(i=a.y-d.y,n=d.x-a.x):(i=d.x-a.x,n=d.y-a.y),t.pv=t.dpv=getUnitVector(i,n)}function SFVTL(o,t){var i,n,r=t.stack,e=r.pop(),p=r.pop(),a=t.z2[e],d=t.z1[p];o?(i=a.y-d.y,n=d.x-a.x):(i=d.x-a.x,n=d.y-a.y),t.fv=getUnitVector(i,n)}function SPVFS(o){var t=o.stack,i=t.pop(),n=t.pop();o.pv=o.dpv=getUnitVector(n,i)}function SFVFS(o){var t=o.stack,i=t.pop(),n=t.pop();o.fv=getUnitVector(n,i)}function GPV(o){var t=o.stack,i=o.pv;t.push(16384*i.x),t.push(16384*i.y)}function GFV(o){var t=o.stack,i=o.fv;t.push(16384*i.x),t.push(16384*i.y)}function SFVTPV(o){o.fv=o.pv}function ISECT(o){var t=o.stack,i=t.pop(),n=t.pop(),r=t.pop(),e=t.pop(),p=t.pop(),a=o.z0,d=o.z1,c=a[i],v=a[n],s=d[r],u=d[e],P=o.z2[p],h=c.x,f=c.y,M=v.x,R=v.y,b=s.x,l=s.y,S=u.x,D=u.y,I=(h-M)*(l-D)-(f-R)*(b-S),k=h*R-f*M,T=b*D-l*S;P.x=(k*(b-S)-T*(h-M))/I,P.y=(k*(l-D)-T*(f-R))/I}function SRP0(o){o.rp0=o.stack.pop()}function SRP1(o){o.rp1=o.stack.pop()}function SRP2(o){o.rp2=o.stack.pop()}function SZP0(o){var t=o.stack.pop();switch(o.zp0=t,t){case 0:o.tZone||initTZone(o),o.z0=o.tZone;break;case 1:o.z0=o.gZone;break;default:throw new Error("Invalid zone pointer")}}function SZP1(o){var t=o.stack.pop();switch(o.zp1=t,t){case 0:o.tZone||initTZone(o),o.z1=o.tZone;break;case 1:o.z1=o.gZone;break;default:throw new Error("Invalid zone pointer")}}function SZP2(o){var t=o.stack.pop();switch(o.zp2=t,t){case 0:o.tZone||initTZone(o),o.z2=o.tZone;break;case 1:o.z2=o.gZone;break;default:throw new Error("Invalid zone pointer")}}function SZPS(o){var t=o.stack.pop();switch(o.zp0=o.zp1=o.zp2=t,t){case 0:o.tZone||initTZone(o),o.z0=o.z1=o.z2=o.tZone;break;case 1:o.z0=o.z1=o.z2=o.gZone;break;default:throw new Error("Invalid zone pointer")}}function SLOOP(o){o.loop=o.stack.pop()}function RTG(o){o.round=roundToGrid}function RTHG(o){o.round=roundToHalfGrid}function SMD(o){var t=o.stack.pop();o.minDis=t/64}function ELSE(o){skip(o,!1)}function JMPR(o){var t=o.stack.pop();o.ip+=t-1}function SCVTCI(o){var t=o.stack.pop();o.cvCutIn=t/64}function DUP(o){var t=o.stack;t.push(t[t.length-1])}function POP(o){o.stack.pop()}function CLEAR(o){o.stack.length=0}function SWAP(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(i),t.push(n)}function DEPTH(o){var t=o.stack;t.push(t.length)}function LOOPCALL(o){var t=o.stack,i=t.pop(),n=t.pop(),r=o.ip,e=o.prog;o.prog=o.funcs[i];for(var p=0;p<n;p++)exec(o);o.ip=r,o.prog=e}function CALL(o){var t=o.stack.pop(),i=o.ip,n=o.prog;o.prog=o.funcs[t],exec(o),o.ip=i,o.prog=n}function CINDEX(o){var t=o.stack,i=t.pop();t.push(t[t.length-i])}function MINDEX(o){var t=o.stack,i=t.pop();t.push(t.splice(t.length-i,1)[0])}function FDEF(o){if("fpgm"!==o.env)throw new Error("FDEF not allowed here");for(var t=o.stack,i=o.prog,n=o.ip,r=t.pop(),e=n;45!==i[++n];);o.ip=n,o.funcs[r]=i.slice(e+1,n)}function MDAP(o,t){var i=t.stack.pop(),n=t.z0[i],r=t.fv,e=t.pv,p=e.distance(n,HPZero);o&&(p=t.round(p)),r.setRelative(n,HPZero,p,e),r.touch(n),t.rp0=t.rp1=i}function IUP(o,t){for(var i,n,r,e=t.z2,p=e.length-2,a=0;a<p;a++)i=e[a],o.touched(i)||(n=i.prevTouched(o),n!==i&&(r=i.nextTouched(o),n===r&&o.setRelative(i,i,o.distance(n,n,!1,!0),o,!0),o.interpolate(i,n,r,o)))}function SHP(o,t){for(var i=t.stack,n=o?t.rp1:t.rp2,r=(o?t.z0:t.z1)[n],e=t.fv,p=t.pv,a=t.loop,d=t.z2;a--;){var c=i.pop(),v=d[c],s=p.distance(r,r,!1,!0);e.setRelative(v,v,s,p),e.touch(v)}t.loop=1}function SHC(o,t){var i=t.stack,n=o?t.rp1:t.rp2,r=(o?t.z0:t.z1)[n],e=t.fv,p=t.pv,a=i.pop(),d=t.z2[t.contours[a]],c=d,v=p.distance(r,r,!1,!0);do c!==r&&e.setRelative(c,c,v,p),c=c.nextPointOnContour;while(c!==d)}function SHZ(o,t){var i,n=t.stack,r=o?t.rp1:t.rp2,e=(o?t.z0:t.z1)[r],p=t.fv,a=t.pv,d=n.pop();switch(d){case 0:i=t.tZone;break;case 1:i=t.gZone;break;default:throw new Error("Invalid zone")}for(var c,v=a.distance(e,e,!1,!0),s=i.length-2,u=0;u<s;u++)c=i[u],c!==e&&p.setRelative(c,c,v,a)}function SHPIX(o){for(var t=o.stack,i=o.loop,n=o.fv,r=t.pop()/64,e=o.z2;i--;){var p=t.pop(),a=e[p];n.setRelative(a,a,r),n.touch(a)}o.loop=1}function IP(o){for(var t=o.stack,i=o.rp1,n=o.rp2,r=o.loop,e=o.z0[i],p=o.z1[n],a=o.fv,d=o.dpv,c=o.z2;r--;){var v=t.pop(),s=c[v];a.interpolate(s,e,p,d),a.touch(s)}o.loop=1}function MSIRP(o,t){var i=t.stack,n=i.pop()/64,r=i.pop(),e=t.z1[r],p=t.z0[t.rp0],a=t.fv,d=t.pv;a.setRelative(e,p,n,d),a.touch(e),t.rp1=t.rp0,t.rp2=r,o&&(t.rp0=r)}function ALIGNRP(o){for(var t=o.stack,i=o.rp0,n=o.z0[i],r=o.loop,e=o.fv,p=o.pv,a=o.z1;r--;){var d=t.pop(),c=a[d];e.setRelative(c,n,0,p),e.touch(c)}o.loop=1}function RTDG(o){o.round=roundToDoubleGrid}function MIAP(o,t){var i=t.stack,n=i.pop(),r=i.pop(),e=t.z0[r],p=t.fv,a=t.pv,d=t.cvt[n];o&&(d=t.round(d)),p.setRelative(e,HPZero,d,a),0===t.zp0&&(e.xo=e.x,e.yo=e.y),p.touch(e),t.rp0=t.rp1=r}function NPUSHB(o){for(var t=o.prog,i=o.ip,n=o.stack,r=t[++i],e=0;e<r;e++)n.push(t[++i]);o.ip=i}function NPUSHW(o){for(var t=o.ip,i=o.prog,n=o.stack,r=i[++t],e=0;e<r;e++){var p=i[++t]<<8|i[++t];32768&p&&(p=-((65535^p)+1)),n.push(p)}o.ip=t}function WS(o){var t=o.stack,i=o.store;i||(i=o.store=[]);var n=t.pop(),r=t.pop();i[r]=n}function RS(o){var t=o.stack,i=o.store,n=t.pop(),r=i&&i[n]||0;t.push(r)}function WCVTP(o){var t=o.stack,i=t.pop(),n=t.pop();o.cvt[n]=i/64}function RCVT(o){var t=o.stack,i=t.pop();t.push(64*o.cvt[i])}function GC(o,t){var i=t.stack,n=i.pop(),r=t.z2[n];i.push(64*t.dpv.distance(r,HPZero,o,!1))}function MD(o,t){var i=t.stack,n=i.pop(),r=i.pop(),e=t.z1[n],p=t.z0[r],a=t.dpv.distance(p,e,o,o);t.stack.push(Math.round(64*a))}function MPPEM(o){o.stack.push(o.ppem)}function FLIPON(o){o.autoFlip=!0}function LT(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(n<i?1:0)}function LTEQ(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(n<=i?1:0)}function GT(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(n>i?1:0)}function GTEQ(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(n>=i?1:0)}function EQ(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(i===n?1:0)}function NEQ(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(i!==n?1:0)}function ODD(o){var t=o.stack,i=t.pop();t.push(Math.trunc(i)%2?1:0)}function EVEN(o){var t=o.stack,i=t.pop();t.push(Math.trunc(i)%2?0:1)}function IF(o){var t=o.stack.pop();t||skip(o,!0)}function EIF(o){}function AND(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(i&&n?1:0)}function OR(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(i||n?1:0)}function NOT(o){var t=o.stack,i=t.pop();t.push(i?0:1)}function DELTAP123(o,t){for(var i=t.stack,n=i.pop(),r=t.fv,e=t.pv,p=t.ppem,a=t.deltaBase+16*(o-1),d=t.deltaShift,c=t.z0,v=0;v<n;v++){var s=i.pop(),u=i.pop(),P=a+((240&u)>>4);if(P===p){var h=(15&u)-8;h>=0&&h++;var f=c[s];r.setRelative(f,f,h*d,e)}}}function SDB(o){var t=o.stack,i=t.pop();o.deltaBase=i}function SDS(o){var t=o.stack,i=t.pop();o.deltaShift=Math.pow(.5,i)}function ADD(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(n+i)}function SUB(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(n-i)}function DIV(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(64*n/i)}function MUL(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(n*i/64)}function ABS(o){var t=o.stack,i=t.pop();t.push(Math.abs(i))}function NEG(o){var t=o.stack,i=t.pop();t.push(-i)}function FLOOR(o){var t=o.stack,i=t.pop();t.push(64*Math.floor(i/64))}function CEILING(o){var t=o.stack,i=t.pop();t.push(64*Math.ceil(i/64))}function ROUND(o,t){var i=t.stack,n=i.pop();i.push(64*t.round(n/64))}function WCVTF(o){var t=o.stack,i=t.pop(),n=t.pop();o.cvt[n]=i*o.ppem/o.font.unitsPerEm}function DELTAC123(o,t){for(var i=t.stack,n=i.pop(),r=t.ppem,e=t.deltaBase+16*(o-1),p=t.deltaShift,a=0;a<n;a++){var d=i.pop(),c=i.pop(),v=e+((240&c)>>4);if(v===r){var s=(15&c)-8;s>=0&&s++;var u=s*p;t.cvt[d]+=u}}}function SROUND(o){var t=o.stack.pop();o.round=roundSuper;var i;switch(192&t){case 0:i=.5;break;case 64:i=1;break;case 128:i=2;break;default:throw new Error("invalid SROUND value")}switch(o.srPeriod=i,48&t){case 0:o.srPhase=0;break;case 16:o.srPhase=.25*i;break;case 32:o.srPhase=.5*i;break;case 48:o.srPhase=.75*i;break;default:throw new Error("invalid SROUND value")}t&=15,0===t?o.srThreshold=0:o.srThreshold=(t/8-.5)*i}function S45ROUND(o){var t=o.stack.pop();o.round=roundSuper;var i;switch(192&t){case 0:i=Math.sqrt(2)/2;break;case 64:i=Math.sqrt(2);break;case 128:i=2*Math.sqrt(2);break;default:throw new Error("invalid S45ROUND value")}switch(o.srPeriod=i,48&t){case 0:o.srPhase=0;break;case 16:o.srPhase=.25*i;break;case 32:o.srPhase=.5*i;break;case 48:o.srPhase=.75*i;break;default:throw new Error("invalid S45ROUND value")}t&=15,0===t?o.srThreshold=0:o.srThreshold=(t/8-.5)*i}function ROFF(o){o.round=roundOff}function RUTG(o){o.round=roundUpToGrid}function RDTG(o){o.round=roundDownToGrid}function SCANCTRL(o){o.stack.pop()}function SDPVTL(o,t){var i,n,r=t.stack,e=r.pop(),p=r.pop(),a=t.z2[e],d=t.z1[p];o?(i=a.y-d.y,n=d.x-a.x):(i=d.x-a.x,n=d.y-a.y),t.dpv=getUnitVector(i,n)}function GETINFO(o){var t=o.stack,i=t.pop(),n=0;1&i&&(n=35),32&i&&(n|=4096),t.push(n)}function ROLL(o){var t=o.stack,i=t.pop(),n=t.pop(),r=t.pop();t.push(n),t.push(i),t.push(r)}function MAX(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(Math.max(n,i))}function MIN(o){var t=o.stack,i=t.pop(),n=t.pop();t.push(Math.min(n,i))}function SCANTYPE(o){o.stack.pop()}function INSTCTRL(o){var t=o.stack.pop(),i=o.stack.pop();switch(t){case 1:return void(o.inhibitGridFit=!!i);case 2:return void(o.ignoreCvt=!!i);default:throw new Error("invalid INSTCTRL[] selector")}}function PUSHB(o,t){for(var i=t.stack,n=t.prog,r=t.ip,e=0;e<o;e++)i.push(n[++r]);t.ip=r}function PUSHW(o,t){for(var i=t.ip,n=t.prog,r=t.stack,e=0;e<o;e++){var p=n[++i]<<8|n[++i];32768&p&&(p=-((65535^p)+1)),r.push(p)}t.ip=i}function MDRP_MIRP(o,t,i,n,r,e){var p,a,d,c,v=e.stack,s=o&&v.pop(),u=v.pop(),P=e.rp0,h=e.z0[P],f=e.z1[u],M=e.minDis,R=e.fv,b=e.dpv;a=p=b.distance(f,h,!0,!0),d=a>=0?1:-1,a=Math.abs(a),o&&(c=e.cvt[s],n&&Math.abs(a-c)<e.cvCutIn&&(a=c)),i&&a<M&&(a=M),n&&(a=e.round(a)),R.setRelative(f,h,d*a,b),R.touch(f),e.rp1=e.rp0,e.rp2=u,t&&(e.rp0=u)}var instructionTable,exec,execComponent,execGlyph,roundSuper=function(o){var t=this.srPeriod,i=this.srPhase,n=this.srThreshold,r=1;return o<0&&(o=-o,r=-1),o+=n-i,o=Math.trunc(o/t)*t,o+=i,r>0&&o<0?i:r<0&&o>0?-i:o*r},xUnitVector={x:1,y:0,axis:"x",distance:function(o,t,i,n){return(i?o.xo:o.x)-(n?t.xo:t.x)},interpolate:function(o,t,i,n){var r,e,p,a,d,c,v;return n&&n!==this?(r=n.distance(o,t,!0,!0),e=n.distance(o,i,!0,!0),d=n.distance(t,t,!1,!0),c=n.distance(i,i,!1,!0),p=Math.abs(r),a=Math.abs(e),v=p+a,0===v?void xUnitVector.setRelative(o,o,(d+c)/2,n,!0):void xUnitVector.setRelative(o,o,(d*a+c*p)/v,n,!0)):(r=o.xo-t.xo,e=o.xo-i.xo,d=t.x-t.xo,c=i.x-i.xo,p=Math.abs(r),a=Math.abs(e),v=p+a,0===v?void(o.x=o.xo+(d+c)/2):void(o.x=o.xo+(d*a+c*p)/v))},normalSlope:Number.NEGATIVE_INFINITY,setRelative:function(o,t,i,n,r){if(!n||n===this)return void(o.x=(r?t.xo:t.x)+i);var e=r?t.xo:t.x,p=r?t.yo:t.y,a=e+i*n.x,d=p+i*n.y;o.x=a+(o.y-d)/n.normalSlope},slope:0,touch:function(o){o.xTouched=!0},touched:function(o){return o.xTouched},untouch:function(o){o.xTouched=!1}},yUnitVector={x:0,y:1,axis:"y",distance:function(o,t,i,n){return(i?o.yo:o.y)-(n?t.yo:t.y)},interpolate:function(o,t,i,n){var r,e,p,a,d,c,v;return n&&n!==this?(r=n.distance(o,t,!0,!0),e=n.distance(o,i,!0,!0),d=n.distance(t,t,!1,!0),c=n.distance(i,i,!1,!0),p=Math.abs(r),a=Math.abs(e),v=p+a,0===v?void yUnitVector.setRelative(o,o,(d+c)/2,n,!0):void yUnitVector.setRelative(o,o,(d*a+c*p)/v,n,!0)):(r=o.yo-t.yo,e=o.yo-i.yo,d=t.y-t.yo,c=i.y-i.yo,p=Math.abs(r),a=Math.abs(e),v=p+a,0===v?void(o.y=o.yo+(d+c)/2):void(o.y=o.yo+(d*a+c*p)/v))},normalSlope:0,setRelative:function(o,t,i,n,r){if(!n||n===this)return void(o.y=(r?t.yo:t.y)+i);var e=r?t.xo:t.x,p=r?t.yo:t.y,a=e+i*n.x,d=p+i*n.y;o.y=d+n.normalSlope*(o.x-a)},slope:Number.POSITIVE_INFINITY,touch:function(o){o.yTouched=!0},touched:function(o){return o.yTouched},untouch:function(o){o.yTouched=!1}};Object.freeze(xUnitVector),Object.freeze(yUnitVector),UnitVector.prototype.distance=function(o,t,i,n){return this.x*xUnitVector.distance(o,t,i,n)+this.y*yUnitVector.distance(o,t,i,n)},UnitVector.prototype.interpolate=function(o,t,i,n){var r,e,p,a,d,c,v;return p=n.distance(o,t,!0,!0),a=n.distance(o,i,!0,!0),r=n.distance(t,t,!1,!0),e=n.distance(i,i,!1,!0),d=Math.abs(p),c=Math.abs(a),v=d+c,0===v?void this.setRelative(o,o,(r+e)/2,n,!0):void this.setRelative(o,o,(r*c+e*d)/v,n,!0)},UnitVector.prototype.setRelative=function(o,t,i,n,r){n=n||this;var e=r?t.xo:t.x,p=r?t.yo:t.y,a=e+i*n.x,d=p+i*n.y,c=n.normalSlope,v=this.slope,s=o.x,u=o.y;o.x=(v*s-c*a+d-u)/(v-c),o.y=v*(o.x-s)+u},UnitVector.prototype.touch=function(o){o.xTouched=!0,o.yTouched=!0},HPoint.prototype.nextTouched=function(o){for(var t=this.nextPointOnContour;!o.touched(t)&&t!==this;)t=t.nextPointOnContour;return t},HPoint.prototype.prevTouched=function(o){for(var t=this.prevPointOnContour;!o.touched(t)&&t!==this;)t=t.prevPointOnContour;return t};var HPZero=Object.freeze(new HPoint(0,0)),defaultState={cvCutIn:17/16,deltaBase:9,deltaShift:.125,loop:1,minDis:1,autoFlip:!0};Hinting.prototype.exec=function(o,t){if("number"!=typeof t)throw new Error("Point size is not a number!");if(!(this._errorState>2)){var i=this.font,n=this._prepState;if(!n||n.ppem!==t){var r=this._fpgmState;if(!r){State.prototype=defaultState,r=this._fpgmState=new State("fpgm",i.tables.fpgm),r.funcs=[],r.font=i;try{exec(r)}catch(o){return console.log("Hinting error in FPGM:"+o),void(this._errorState=3)}}State.prototype=r,n=this._prepState=new State("prep",i.tables.prep),n.ppem=t;var e=i.tables.cvt;if(e)for(var p=n.cvt=new Array(e.length),a=t/i.unitsPerEm,d=0;d<e.length;d++)p[d]=e[d]*a;else n.cvt=[];try{exec(n)}catch(o){this._errorState<2&&console.log("Hinting error in PREP:"+o),this._errorState=2}}if(!(this._errorState>1))try{return execGlyph(o,n)}catch(o){return this._errorState<1&&(console.log("Hinting error:"+o),console.log("Note: further hinting errors are silenced")),void(this._errorState=1)}}},instructionTable=[SVTCA.bind(void 0,yUnitVector),SVTCA.bind(void 0,xUnitVector),SPVTCA.bind(void 0,yUnitVector),SPVTCA.bind(void 0,xUnitVector),SFVTCA.bind(void 0,yUnitVector),SFVTCA.bind(void 0,xUnitVector),SPVTL.bind(void 0,0),SPVTL.bind(void 0,1),SFVTL.bind(void 0,0),SFVTL.bind(void 0,1),SPVFS,SFVFS,GPV,GFV,SFVTPV,ISECT,SRP0,SRP1,SRP2,SZP0,SZP1,SZP2,SZPS,SLOOP,RTG,RTHG,SMD,ELSE,JMPR,SCVTCI,void 0,void 0,DUP,POP,CLEAR,SWAP,DEPTH,CINDEX,MINDEX,void 0,void 0,void 0,LOOPCALL,CALL,FDEF,void 0,MDAP.bind(void 0,0),MDAP.bind(void 0,1),IUP.bind(void 0,yUnitVector),IUP.bind(void 0,xUnitVector),SHP.bind(void 0,0),SHP.bind(void 0,1),SHC.bind(void 0,0),SHC.bind(void 0,1),SHZ.bind(void 0,0),SHZ.bind(void 0,1),SHPIX,IP,MSIRP.bind(void 0,0),MSIRP.bind(void 0,1),ALIGNRP,RTDG,MIAP.bind(void 0,0),MIAP.bind(void 0,1),NPUSHB,NPUSHW,WS,RS,WCVTP,RCVT,GC.bind(void 0,0),GC.bind(void 0,1),void 0,MD.bind(void 0,0),MD.bind(void 0,1),MPPEM,void 0,FLIPON,void 0,void 0,LT,LTEQ,GT,GTEQ,EQ,NEQ,ODD,EVEN,IF,EIF,AND,OR,NOT,DELTAP123.bind(void 0,1),SDB,SDS,ADD,SUB,DIV,MUL,ABS,NEG,FLOOR,CEILING,ROUND.bind(void 0,0),ROUND.bind(void 0,1),ROUND.bind(void 0,2),ROUND.bind(void 0,3),void 0,void 0,void 0,void 0,WCVTF,DELTAP123.bind(void 0,2),DELTAP123.bind(void 0,3),DELTAC123.bind(void 0,1),DELTAC123.bind(void 0,2),DELTAC123.bind(void 0,3),SROUND,S45ROUND,void 0,void 0,ROFF,void 0,RUTG,RDTG,POP,POP,void 0,void 0,void 0,void 0,void 0,SCANCTRL,SDPVTL.bind(void 0,0),SDPVTL.bind(void 0,1),GETINFO,void 0,ROLL,MAX,MIN,SCANTYPE,INSTCTRL,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,void 0,PUSHB.bind(void 0,1),PUSHB.bind(void 0,2),PUSHB.bind(void 0,3),PUSHB.bind(void 0,4),PUSHB.bind(void 0,5),PUSHB.bind(void 0,6),PUSHB.bind(void 0,7),PUSHB.bind(void 0,8),PUSHW.bind(void 0,1),PUSHW.bind(void 0,2),PUSHW.bind(void 0,3),PUSHW.bind(void 0,4),PUSHW.bind(void 0,5),PUSHW.bind(void 0,6),PUSHW.bind(void 0,7),PUSHW.bind(void 0,8),MDRP_MIRP.bind(void 0,0,0,0,0,0),MDRP_MIRP.bind(void 0,0,0,0,0,1),MDRP_MIRP.bind(void 0,0,0,0,0,2),MDRP_MIRP.bind(void 0,0,0,0,0,3),MDRP_MIRP.bind(void 0,0,0,0,1,0),MDRP_MIRP.bind(void 0,0,0,0,1,1),MDRP_MIRP.bind(void 0,0,0,0,1,2),MDRP_MIRP.bind(void 0,0,0,0,1,3),MDRP_MIRP.bind(void 0,0,0,1,0,0),MDRP_MIRP.bind(void 0,0,0,1,0,1),MDRP_MIRP.bind(void 0,0,0,1,0,2),MDRP_MIRP.bind(void 0,0,0,1,0,3),MDRP_MIRP.bind(void 0,0,0,1,1,0),MDRP_MIRP.bind(void 0,0,0,1,1,1),MDRP_MIRP.bind(void 0,0,0,1,1,2),MDRP_MIRP.bind(void 0,0,0,1,1,3),MDRP_MIRP.bind(void 0,0,1,0,0,0),MDRP_MIRP.bind(void 0,0,1,0,0,1),MDRP_MIRP.bind(void 0,0,1,0,0,2),MDRP_MIRP.bind(void 0,0,1,0,0,3),MDRP_MIRP.bind(void 0,0,1,0,1,0),MDRP_MIRP.bind(void 0,0,1,0,1,1),MDRP_MIRP.bind(void 0,0,1,0,1,2),MDRP_MIRP.bind(void 0,0,1,0,1,3),MDRP_MIRP.bind(void 0,0,1,1,0,0),MDRP_MIRP.bind(void 0,0,1,1,0,1),MDRP_MIRP.bind(void 0,0,1,1,0,2),MDRP_MIRP.bind(void 0,0,1,1,0,3),MDRP_MIRP.bind(void 0,0,1,1,1,0),MDRP_MIRP.bind(void 0,0,1,1,1,1),MDRP_MIRP.bind(void 0,0,1,1,1,2),MDRP_MIRP.bind(void 0,0,1,1,1,3),MDRP_MIRP.bind(void 0,1,0,0,0,0),MDRP_MIRP.bind(void 0,1,0,0,0,1),MDRP_MIRP.bind(void 0,1,0,0,0,2),MDRP_MIRP.bind(void 0,1,0,0,0,3),MDRP_MIRP.bind(void 0,1,0,0,1,0),MDRP_MIRP.bind(void 0,1,0,0,1,1),MDRP_MIRP.bind(void 0,1,0,0,1,2),MDRP_MIRP.bind(void 0,1,0,0,1,3),MDRP_MIRP.bind(void 0,1,0,1,0,0),MDRP_MIRP.bind(void 0,1,0,1,0,1),MDRP_MIRP.bind(void 0,1,0,1,0,2),MDRP_MIRP.bind(void 0,1,0,1,0,3),MDRP_MIRP.bind(void 0,1,0,1,1,0),MDRP_MIRP.bind(void 0,1,0,1,1,1),MDRP_MIRP.bind(void 0,1,0,1,1,2),MDRP_MIRP.bind(void 0,1,0,1,1,3),MDRP_MIRP.bind(void 0,1,1,0,0,0),MDRP_MIRP.bind(void 0,1,1,0,0,1),MDRP_MIRP.bind(void 0,1,1,0,0,2),MDRP_MIRP.bind(void 0,1,1,0,0,3),MDRP_MIRP.bind(void 0,1,1,0,1,0),MDRP_MIRP.bind(void 0,1,1,0,1,1),MDRP_MIRP.bind(void 0,1,1,0,1,2),MDRP_MIRP.bind(void 0,1,1,0,1,3),MDRP_MIRP.bind(void 0,1,1,1,0,0),MDRP_MIRP.bind(void 0,1,1,1,0,1),MDRP_MIRP.bind(void 0,1,1,1,0,2),MDRP_MIRP.bind(void 0,1,1,1,0,3),MDRP_MIRP.bind(void 0,1,1,1,1,0),MDRP_MIRP.bind(void 0,1,1,1,1,1),MDRP_MIRP.bind(void 0,1,1,1,1,2),MDRP_MIRP.bind(void 0,1,1,1,1,3)],module.exports=Hinting;
