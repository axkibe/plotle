	...
	function( )
{
	return(
		{
			type : 'trace',
			trace : [ '(o)jp2' ].concat( this.last.asJSON.trace )
		}
	);
};
	...
	)
{
	if( CHECK )
/**/{
/**/	if( trace[ pos ] !== '(o)jp2' ) throw new Error( );
/**/}

	return trace_base.createFromJSONTrace( trace, pos + 1 ).appendJP2;
};
...
{
	return this.last.pick( tree ).jp2;
};
