	...
	function( )
{
	return(
		{
			type : 'trace',
			trace : [ '(o)from' ].concat( this.last.asJSON.trace )
		}
	);
};
	...
	)
{
	if( CHECK )
/**/{
/**/	if( trace[ pos ] !== '(o)from' ) throw new Error( );
/**/}

	return trace_base.createFromJSONTrace( trace, pos + 1 ).appendFrom;
};
...
{
	return this.last.pick( tree ).from;
};
