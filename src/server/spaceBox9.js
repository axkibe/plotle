...
var
	database9_changeSkid,
	database9_changeSkidRay,
	resume,
	server_spaceBox,
	fabric_space;
...
database9_changeSkid = require( '../database9/changeSkid' );

database9_changeSkidRay = require( '../database9/changeSkidRay' );
	...
	)
{
	...
	changeSkids = database9_changeSkidRay.create( 'ray:init', [ null ] );
	...
	{
		changeSkid = database9_changeSkid.createFromJSON( o );
...
/**/}
	...
	return(
		server_spaceBox.create(
			...
			'_changeSkids',
				database9_changeSkidRay.create( 'ray:init', [ null ] )
		)
	);
...
/**/}
	...
	changeSkidRay =
		database9_changeSkidRay.createFromChangeWrapRay(
			changeWrapRay,
			user,
			this.seqZ
		);
